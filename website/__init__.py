...
from website.models import User, Company, Country, City, Passport
from website.models import Flight, Employment, Booking
from website.admin_views import UserView, CompanyView, CountryView, CityView
from website.admin_views import BookingView, EmploymentView, PassportView
from website.admin_views import FlightView
